  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="flex flex-col gap-4 items-center justify-center text-center text-foreground uppercase"
      >
        <span className="flex justify-center items-center gap-2">
          <Bitcoin className="w-[46px] h-[46px] -mr-2 text-primary" />
          Send a <span className="text-primary">{" "}Tip</span>
        </span>
        or buy me
        <span className="flex justify-center items-center gap-2">
          A <span className="text-primary">Coffee</span>
          <Coffee className="w-[46px] h-[46px] text-primary" />
        </span>
      </motion.h1>
    </LampContainer>
  );
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 items-start justify-center isolate z-0 ">
        ...
        <div className="relative z-50 flex mt-[8rem] flex-col items-center px-5">
          {children}
        </div>
      </div>
    </div>
